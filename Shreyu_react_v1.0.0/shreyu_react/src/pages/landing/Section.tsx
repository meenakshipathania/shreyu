...
// dummy data
import { TaskItemTypes } from "./data2";
    ...
    <>
      ...
      >
        ...
        <Col lg={2} className="mb-2 mb-lg-0">
          {/* <span
            className={classNames("badge", {
              "badge-soft-danger": task.stage === "Pending",
              "badge-soft-warning": task.stage === "In-Progress",
              "badge-soft-success": task.stage === "Completed",
            })}
          > */}
            {task.stage}
          {/* </span> */}
        ...
        <Col lg={2}>
          <div className="d-sm-flex justify-content-between">
            ...
            {/* <Dropdown className="mt-2 me-1">
                            ...
                            <Dropdown.Menu>
                                <Dropdown.Item href="#"><img src={require("../../assets/images/Account.svg").default} alt="hfjhf"></img></Dropdown.Item>
